const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AboutSection-C_l30FhG.js","assets/icons-B35_JkTI.js","assets/motion-MmPCslB7.js","assets/react-vendor-MLuijOiN.js","assets/supabase-yKjPlrCh.js","assets/UniqueFeaturesSection-DN3xK_XS.js","assets/IconBox-CYVDy351.js","assets/OpportunitiesSection-DlE7FPfX.js","assets/PartnershipSection-BKXBXgQw.js","assets/InvestmentsSection-DlRB64Mg.js","assets/AdvantagesSection-D4FUbau9.js","assets/RoadmapSection-CSoKHkuT.js","assets/ChefNetAppSection-COuVXblN.js","assets/FAQSection-CtvUyb13.js","assets/CTABanner-B8FhOCbc.js","assets/TeamSection-9gPnkrUI.js","assets/Footer-TaQW4LqQ.js","assets/Dashboard-BYv4tR1c.js","assets/charts-dt3JS_Z5.js","assets/form-libs-B_odSabk.js","assets/form-libs-BuqMdKp-.css"])))=>i.map(i=>d[i]);
import{r as i,j as e,A as G,m as k}from"./motion-MmPCslB7.js";import{e as Se,h as Ce}from"./react-vendor-MLuijOiN.js";import{c as Te}from"./supabase-yKjPlrCh.js";import{X as J,C as X,a as V,L as _,E as q,b as U,G as Ae,M as Ne,c as ee,d as De,R as Pe,U as ze,e as K,f as ue}from"./icons-B35_JkTI.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function l(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(o){if(o.ep)return;o.ep=!0;const n=l(o);fetch(o.href,n)}})();const Ie="modulepreload",je=function(r){return"/"+r},ie={},j=function(a,l,t){let o=Promise.resolve();if(l&&l.length>0){let s=function(m){return Promise.all(m.map(p=>Promise.resolve(p).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),h=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));o=s(l.map(m=>{if(m=je(m),m in ie)return;ie[m]=!0;const p=m.endsWith(".css"),y=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${y}`))return;const c=document.createElement("link");if(c.rel=p?"stylesheet":Ie,p||(c.as="script"),c.crossOrigin="",c.href=m,h&&c.setAttribute("nonce",h),document.head.appendChild(c),p)return new Promise((u,w)=>{c.addEventListener("load",u),c.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${m}`)))})}))}function n(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return o.then(s=>{for(const d of s||[])d.status==="rejected"&&n(d.reason);return a().catch(n)})},Ee={theme:"light",setTheme:()=>null},Be=i.createContext(Ee);function Oe({children:r,defaultTheme:a="light",storageKey:l="vite-ui-theme",...t}){const[o,n]=i.useState(()=>localStorage.getItem(l)||a);i.useEffect(()=>{const d=window.document.documentElement;d.classList.remove("light","dark"),d.classList.add(o),d.setAttribute("data-theme",o)},[o]);const s={theme:o,setTheme:d=>{localStorage.setItem(l,d),n(d)}};return e.jsx(Be.Provider,{...t,value:s,children:r})}const pe=i.createContext(void 0),Z="chefnet-language",Re=()=>{try{const r=localStorage.getItem(Z);if(r&&["en","ru","de","es","tr"].includes(r))return r;r&&(console.warn(`Invalid language "${r}" found in localStorage, resetting to default`),localStorage.removeItem(Z))}catch(r){console.error("Error reading language from localStorage:",r)}return"ru"},Fe=({children:r})=>{const[a,l]=i.useState(Re),t=o=>{try{localStorage.setItem(Z,o),l(o)}catch(n){console.error("Error saving language to localStorage:",n),l(o)}};return e.jsx(pe.Provider,{value:{language:a,setLanguage:t},children:r})},B=()=>{const r=i.useContext(pe);if(!r)throw new Error("useLanguage must be used within a LanguageProvider");return r},Me="https://sdwlngwkeipgwelzxfai.supabase.co",Le="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNkd2xuZ3drZWlwZ3dlbHp4ZmFpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIzNjgwNDksImV4cCI6MjA4Nzk0NDA0OX0.4nDN_CwoJCg-G1t2PPuX-6A2OmRhVXviBOI6kVOUwdo";let Q=null;function me(){return Q||(Q=Te(Me,Le,{auth:{persistSession:!0,autoRefreshToken:!0,detectSessionInUrl:!0,storageKey:"chefnet-auth-storage"}})),Q}async function ne(){const r=me(),{data:{session:a}}=await r.auth.getSession();return a!=null&&a.access_token?{Authorization:`Bearer ${a.access_token}`,"Content-Type":"application/json"}:{"Content-Type":"application/json"}}async function F(r){const a=await ne(),l=await fetch(r,{headers:a});if(!l.ok)throw new Error(`API error: ${l.status}`);return l.json()}async function _e(r,a){const l=await ne(),t=await fetch(r,{method:"POST",headers:l,body:JSON.stringify(a)});if(!t.ok)throw new Error(`API error: ${t.status}`);return t.json()}async function se(r,a){const l=await ne(),t=await fetch(r,{method:"PUT",headers:l,body:JSON.stringify(a)});if(!t.ok)throw new Error(`API error: ${t.status}`);return t.json()}async function oe(){try{const[r,a,l,t,o]=await Promise.allSettled([F("/api/rounds"),F("/api/investments"),F("/api/referrals"),F("/api/kyc"),F("/api/profile")]);if(r.status==="fulfilled"&&r.value.length>0){const n=r.value,s=a.status==="fulfilled"?a.value.userRounds:[],d={},h={seed:"Seed",seriesA:"Private",marketing:"Marketing",ipo:"Public/IPO"},m={seed:"Раунд посева",seriesA:"Серия A",marketing:"Серия B",ipo:"Серия C / IPO"};n.forEach(p=>{const y=h[p.id]||p.id,c=s.find(u=>u.round_id===p.id);d[y]={id:p.id,name:m[p.id]||p.name,price:parseFloat(p.price),minInvestment:parseFloat(p.min_investment),totalShares:p.total_shares,soldShares:p.sold_shares,myShares:c?c.my_shares:0,status:p.status==="active"?"Активный":p.status==="upcoming"?"Вскоре":"Распроданный",amount:p.amount,highlight:p.highlight}}),localStorage.setItem("chefnet_rounds_data",JSON.stringify(d))}if(a.status==="fulfilled"&&a.value.investments.length>0){const n=a.value.investments.map(s=>({round:s.round==="seed"?"Seed":s.round,shares:s.shares,amount:s.amount,date:s.date,status:s.status}));localStorage.setItem("chefnet_investments",JSON.stringify(n))}if(l.status==="fulfilled"&&l.value.length>0){const n=l.value.map(s=>({name:s.name,status:s.status,amount:s.amount,shares:s.shares,commission:s.commission,date:s.date,round:s.round}));localStorage.setItem("chefnet_referrals_data",JSON.stringify(n)),localStorage.setItem("chefnet_referrals_version","6.0")}if(t.status==="fulfilled"&&t.value.status!=="not_started"){const n=t.value;localStorage.setItem("chefnet_kyc_status",n.status),n.full_name&&localStorage.setItem("chefnet_kyc_data",JSON.stringify({fullName:n.full_name,dateOfBirth:n.date_of_birth||"",country:n.country||"",address:n.address||"",email:n.email||"",phone:n.phone||""})),n.verified_date&&localStorage.setItem("chefnet_kyc_verified_date",n.verified_date)}if(o.status==="fulfilled"&&o.value){const n=o.value;localStorage.setItem("chefnet_profile_data",JSON.stringify({fullName:n.full_name||"",email:n.email||"",phone:n.phone||"",country:n.country||"",address:n.address||"",dateOfBirth:n.date_of_birth||"",nationality:n.nationality||"",zipCode:n.zip_code||""}))}}catch(r){console.error("Error loading data from server:",r)}}async function qe(){try{const r=localStorage.getItem("chefnet_kyc_status"),a=localStorage.getItem("chefnet_kyc_data"),l=localStorage.getItem("chefnet_profile_data"),t=[];if(r&&r!=="not_started"){const o=a?JSON.parse(a):{};t.push(se("/api/kyc",{status:r,full_name:o.fullName||"",date_of_birth:o.dateOfBirth||"",country:o.country||"",address:o.address||"",email:o.email||"",phone:o.phone||""}))}if(l){const o=JSON.parse(l);t.push(se("/api/profile",{full_name:o.fullName||"",email:o.email||"",phone:o.phone||"",country:o.country||"",address:o.address||"",date_of_birth:o.dateOfBirth||"",nationality:o.nationality||"",zip_code:o.zipCode||""}))}await Promise.allSettled(t)}catch(r){console.error("Error saving data to server:",r)}}async function le(){try{await _e("/api/seed-demo-data",{})}catch(r){console.error("Error seeding demo data:",r)}}function Ue(){["chefnet_rounds_data","chefnet_investments","chefnet_referrals_data","chefnet_referrals_version","chefnet_kyc_status","chefnet_kyc_data","chefnet_kyc_verified_date","chefnet_kyc_sumsub_applicant_id","chefnet_kyc_sumsub_inspection_id","chefnet_profile_data","chefnet_user_email"].forEach(a=>localStorage.removeItem(a))}function Ke(){if(typeof window<"u"){const r=window.location.origin;if(!r.includes("localhost")&&!r.includes("127.0.0.1"))return r}return"https://42494885-bbef-45f9-b43e-8e821de7357f-00-rqlrkj293o1v.worf.replit.dev"}const he=i.createContext(void 0);function H(r){var a,l;return{id:r.id,email:r.email||"",firstName:((a=r.user_metadata)==null?void 0:a.firstName)||"",lastName:((l=r.user_metadata)==null?void 0:l.lastName)||"",createdAt:r.created_at||new Date().toISOString()}}const Ge=({children:r})=>{const[a,l]=i.useState(null),[t,o]=i.useState(!0),[n,s]=i.useState(null),[d,h]=i.useState(!1),m=me(),p=i.useRef(!1),y=i.useRef(!1),c=i.useRef(!1);async function u(b){try{const g=await fetch("/api/email-status",{headers:{Authorization:`Bearer ${b}`,"Content-Type":"application/json"}});if(g.ok)return(await g.json()).verified===!0}catch(g){console.error("Email verification check failed:",g)}return!1}i.useEffect(()=>{m.auth.getSession().then(async({data:{session:S}})=>{if(S!=null&&S.user&&!y.current){if(!await u(S.access_token)){await m.auth.signOut(),l(null),o(!1);return}const A=H(S.user);l(A),p.current||(p.current=!0,await le(),await oe())}o(!1)});const b={current:!1},{data:{subscription:g}}=m.auth.onAuthStateChange(async(S,v)=>{if(!(y.current||c.current||b.current)){if(S==="PASSWORD_RECOVERY"&&(v!=null&&v.user)){h(!0),o(!1);return}if(v!=null&&v.user){if(!await u(v.access_token)){b.current=!0,await m.auth.signOut(),b.current=!1,l(null),o(!1);return}const C=H(v.user);l(C),p.current||(p.current=!0,await le(),await oe())}else p.current=!1,l(null);o(!1)}});return()=>g.unsubscribe()},[]);const w=async(b,g,S,v,A,C)=>{try{s(null),y.current=!0;const O=await fetch("/api/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:b,password:g,firstName:S,lastName:v,lang:A||"ru",ref:C||null})});if(!O.ok){const M=(await O.json().catch(()=>({error:"Registration failed"}))).error||"Registration failed";return console.error("Registration error:",M),s(M),y.current=!1,"error"}return l(null),y.current=!1,"confirmation_needed"}catch(O){return console.error("Registration exception:",O),s("An unexpected error occurred"),y.current=!1,"error"}},f=async(b,g)=>{try{return s(null),(await fetch("/api/send-verification",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:b,firstName:"",lang:g||"ru"})})).ok?!0:(s("Failed to resend verification email"),!1)}catch{return s("An unexpected error occurred"),!1}},N=async(b,g,S)=>{var v;try{s(null),c.current=!0;const{data:A,error:C}=await m.auth.signInWithPassword({email:b,password:g});return C?(console.error("Login error:",C.message),s(C.message),c.current=!1,!1):A.user?await u(((v=A.session)==null?void 0:v.access_token)||"")?(c.current=!1,l(H(A.user)),!0):(await m.auth.signOut(),l(null),s("email_not_verified"),c.current=!1,!1):(c.current=!1,!1)}catch(A){return console.error("Login exception:",A),s("An unexpected error occurred"),c.current=!1,!1}},I=async()=>{await qe(),Ue(),p.current=!1,await m.auth.signOut(),l(null)},P=()=>{h(!1)},T=async b=>{try{s(null);const{error:g}=await m.auth.updateUser({password:b});return g?(console.error("Update password error:",g.message),s(g.message),!1):(h(!1),!0)}catch(g){return console.error("Update password exception:",g),s("An unexpected error occurred"),!1}},E=async(b,g,S="ru")=>{try{s(null);const v=await fetch("/api/reset-password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:b,lang:S})});if(!v.ok){const C=(await v.json().catch(()=>({}))).error||"Failed to send reset email";return console.error("Password reset error:",C),s(C),!1}return!0}catch(v){return console.error("Password reset exception:",v),s("An unexpected error occurred"),!1}},z=async()=>{try{s(null);const{error:b}=await m.auth.signInWithOAuth({provider:"google",options:{redirectTo:Ke()}});b&&(console.error("Google login error:",b.message),s(b.message))}catch(b){console.error("Google login exception:",b),s("An unexpected error occurred")}};return e.jsx(he.Provider,{value:{user:a,isAuthenticated:!!a,loading:t,login:N,register:w,logout:I,loginWithGoogle:z,resetPassword:E,updatePassword:T,resendConfirmationEmail:f,authError:n,isPasswordRecovery:d,clearPasswordRecovery:P},children:r})},R=()=>{const r=i.useContext(he);if(!r)throw new Error("useAuth must be used within an AuthProvider");return r};function ce({resetToken:r,onClose:a}){const{updatePassword:l,clearPasswordRecovery:t,authError:o}=R(),{language:n}=B(),[s,d]=i.useState(""),[h,m]=i.useState(""),[p,y]=i.useState(!1),[c,u]=i.useState(!1),[w,f]=i.useState(""),[N,I]=i.useState(!1),P={ru:{title:"Новый пароль",subtitle:"Введите новый пароль для вашего аккаунта",password:"Новый пароль",confirm:"Подтвердите пароль",submit:"Сохранить пароль",cancel:"Отмена",successMsg:"Пароль успешно изменён! Теперь вы можете войти.",errorMismatch:"Пароли не совпадают",errorShort:"Пароль должен содержать минимум 8 символов"},en:{title:"New Password",subtitle:"Enter a new password for your account",password:"New password",confirm:"Confirm password",submit:"Save password",cancel:"Cancel",successMsg:"Password changed successfully! You can now log in.",errorMismatch:"Passwords do not match",errorShort:"Password must be at least 8 characters"},de:{title:"Neues Passwort",subtitle:"Geben Sie ein neues Passwort für Ihr Konto ein",password:"Neues Passwort",confirm:"Passwort bestätigen",submit:"Passwort speichern",cancel:"Abbrechen",successMsg:"Passwort erfolgreich geändert! Sie können sich jetzt anmelden.",errorMismatch:"Passwörter stimmen nicht überein",errorShort:"Das Passwort muss mindestens 8 Zeichen lang sein"},es:{title:"Nueva contraseña",subtitle:"Ingresa una nueva contraseña para tu cuenta",password:"Nueva contraseña",confirm:"Confirmar contraseña",submit:"Guardar contraseña",cancel:"Cancelar",successMsg:"¡Contraseña cambiada con éxito! Ahora puedes iniciar sesión.",errorMismatch:"Las contraseñas no coinciden",errorShort:"La contraseña debe tener al menos 8 caracteres"},tr:{title:"Yeni Şifre",subtitle:"Hesabınız için yeni bir şifre girin",password:"Yeni şifre",confirm:"Şifreyi onayla",submit:"Şifreyi kaydet",cancel:"İptal",successMsg:"Şifre başarıyla değiştirildi! Artık giriş yapabilirsiniz.",errorMismatch:"Şifreler eşleşmiyor",errorShort:"Şifre en az 8 karakter olmalıdır"}},T=P[n]||P.ru,E=()=>{r?a==null||a():t()},z=async b=>{if(b.preventDefault(),f(""),s.length<8){f(T.errorShort);return}if(s!==h){f(T.errorMismatch);return}u(!0);let g=!1;if(r)try{const S=await fetch("/api/reset-password-confirm",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,newPassword:s})}),v=await S.json();if(S.ok)g=!0;else{const A=v.error||"";if(A.toLowerCase().includes("unavailable")||A.toLowerCase().includes("temporarily")){const C={ru:"Сервис временно недоступен. Восстановите проект Supabase и попробуйте снова.",en:"Service temporarily unavailable. Please try again later.",de:"Dienst vorübergehend nicht verfügbar. Bitte versuchen Sie es später erneut.",es:"Servicio temporalmente no disponible. Inténtelo más tarde.",tr:"Hizmet geçici olarak kullanılamıyor. Lütfen daha sonra tekrar deneyin."};f(C[n]||C.ru)}else f(A||"Error")}}catch{f(n==="en"?"Network error. Please try again.":"Ошибка сети. Пожалуйста, попробуйте снова.")}else g=await l(s),g||f(o||"Error");u(!1),g&&(I(!0),setTimeout(()=>{r?(window.history.replaceState({},"",window.location.pathname),a==null||a()):t()},3e3))};return e.jsx(G,{children:e.jsx(k.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"fixed inset-0 z-50 flex items-center justify-center p-4",style:{backgroundColor:"rgba(0,0,0,0.5)",backdropFilter:"blur(4px)"},children:e.jsxs(k.div,{initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.9,opacity:0},className:"bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative",children:[e.jsx("button",{onClick:E,className:"absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors",children:e.jsx(J,{className:"w-5 h-5"})}),e.jsxs("div",{className:"mb-6",children:[e.jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-1",children:T.title}),e.jsx("p",{className:"text-gray-500 text-sm",children:T.subtitle})]}),N?e.jsxs(k.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},className:"bg-green-50 border border-green-200 text-green-700 px-4 py-4 rounded-xl flex items-center gap-3",children:[e.jsx(X,{className:"w-5 h-5 flex-shrink-0"}),e.jsx("span",{className:"text-sm",children:T.successMsg})]}):e.jsxs("form",{onSubmit:z,className:"space-y-4",children:[w&&e.jsxs(k.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},className:"bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center gap-2",children:[e.jsx(V,{className:"w-5 h-5 flex-shrink-0"}),e.jsx("span",{className:"text-sm",children:w})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:T.password}),e.jsxs("div",{className:"relative",children:[e.jsx(_,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:p?"text":"password",value:s,onChange:b=>d(b.target.value),className:"w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"••••••••",required:!0}),e.jsx("button",{type:"button",onClick:()=>y(!p),className:"absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600",children:p?e.jsx(q,{className:"w-5 h-5"}):e.jsx(U,{className:"w-5 h-5"})})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:T.confirm}),e.jsxs("div",{className:"relative",children:[e.jsx(_,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:p?"text":"password",value:h,onChange:b=>m(b.target.value),className:"w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"••••••••",required:!0})]})]}),e.jsxs("div",{className:"flex gap-3 pt-2",children:[e.jsx("button",{type:"button",onClick:E,className:"flex-1 py-3 border border-gray-300 text-gray-700 rounded-xl font-medium text-sm hover:bg-gray-50 transition-all",children:T.cancel}),e.jsx(k.button,{type:"submit",disabled:c,whileHover:{scale:c?1:1.02},whileTap:{scale:c?1:.98},className:"flex-1 py-3 bg-gradient-to-r from-[#D4522A] to-[#E8744F] text-white rounded-xl font-medium shadow-lg shadow-orange-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm",children:c?"...":T.submit})]})]})]})})})}const te={en:{features:"Highlights",aboutUs:"Opportunities",forPartners:"For partners",referralProgramme:"Growth stages",stagesOfDevelopment:"Growth stages",whyChefNet:"Why ChefNet?",roadmap:"Roadmap",faq:"FAQ",team:"Team",contacts:"Contacts",logIn:"Log in",signIn:"Sign in",heroTitle1:"Intelligence that turns choice",heroTitle2:"into value.",heroTitle3:"Intelligence,",heroTitle4:"that turns choice into value.",heroSubtitle:"ChefNet is an AI-powered technology",heroDescription:"that learns your rhythm, remembers your taste, and saves you time and money every day.",heroBenefit1:"Restaurants gain new guests.",heroBenefit2:"Guests receive precise, personalized recommendations.",heroBenefit3:"Partners benefit from transparent growth and a dynamic market.",heroCta:"Now is your opportunity to join this movement.",getStarted:"Get Started",opportunitiesTitle:"Opportunities",opportunity1Title:"ChefNet",opportunity1Desc:"Your chance",opportunity2Title:"ChefNet",opportunity2Desc:"Our turn",opportunity3Title:"ChefNet",opportunity3Desc:"Revolution",believeTitle:"Our philosophy",believeSubtitle:"Simplicity in a single touch. Precision — ChefNet style.",believeDesc1:`We're building a service that makes choosing a place as simple as ordering a taxi.
...
Anında rezervasyon ve hazır rota.`,whyCard6Line2:"Dinamik menüler, sesli senaryolar ve uyarlanabilir öneriler — hepsi seçiminizi gerçekten kolay kılarsınız."}},Y=[{code:"ru",name:"Русский",flag:"RU"},{code:"en",name:"English",flag:"EN"},{code:"de",name:"Deutsch",flag:"DE"},{code:"tr",name:"Türkçe",flag:"TR"},{code:"es",name:"Español",flag:"ES"}];function $({variant:r="light"}){const[a,l]=i.useState(!1),{language:t,setLanguage:o}=B(),n=i.useRef(null),s=i.useRef(null),[d,h]=i.useState({top:0,left:0}),m=Y.find(c=>c.code===t)||Y[0];i.useEffect(()=>{if(!a||!n.current)return;const c=()=>{if(n.current){const u=n.current.getBoundingClientRect();h({top:u.bottom+8,left:u.right-200})}};return c(),window.addEventListener("scroll",c,!0),window.addEventListener("resize",c),()=>{window.removeEventListener("scroll",c,!0),window.removeEventListener("resize",c)}},[a]),i.useEffect(()=>{const c=u=>{n.current&&!n.current.contains(u.target)&&s.current&&!s.current.contains(u.target)&&l(!1)};return document.addEventListener("mousedown",c),()=>document.removeEventListener("mousedown",c)},[]);const p=c=>{o(c),l(!1)},y=r==="light"?"text-white hover:text-white/80":"text-gray-700 hover:text-gray-900";return e.jsxs(e.Fragment,{children:[e.jsxs("button",{ref:n,onClick:()=>l(!a),className:`flex items-center gap-2 transition-colors ${y}`,children:[e.jsx(Ae,{className:"w-4 h-4"}),e.jsx("span",{className:"text-[15px] font-medium",children:m.flag})]}),a&&Se.createPortal(e.jsx(G,{children:e.jsx(k.div,{ref:s,initial:{opacity:0,y:-10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.2},className:"fixed bg-white rounded-2xl shadow-xl overflow-hidden min-w-[200px]",style:{top:`${d.top}px`,left:`${d.left}px`,zIndex:99999},children:e.jsx("div",{className:"py-2",children:Y.map(c=>e.jsxs("button",{onClick:()=>p(c.code),className:`w-full px-5 py-3 flex items-center gap-3 hover:bg-background transition-colors ${t===c.code?"bg-background":""}`,children:[e.jsx("span",{className:"text-[#8B4537] text-sm font-medium w-8",children:c.flag}),e.jsx("span",{className:`text-[15px] ${t===c.code?"font-medium text-[#5A2F23]":"font-normal text-[#8B4537]"}`,children:c.name})]},c.code))})})}),document.body)]})}function Ve({onSuccess:r,onSwitchToRegister:a,onSwitchToReset:l}){const[t,o]=i.useState(""),[n,s]=i.useState(""),[d,h]=i.useState(""),[m,p]=i.useState(!1),[y,c]=i.useState(!1),[u,w]=i.useState(!1),[f,N]=i.useState(!1),[I,P]=i.useState(!1),{login:T,authError:E}=R(),{language:z}=B(),g={en:{email:"Email",password:"Password",loginButton:"Log in",noAccount:"Don't have an account?",signUp:"Sign up",errorInvalid:"Invalid email or password",errorFill:"Please fill in all fields",emailNotConfirmed:"Please confirm your email first. Check your inbox for the confirmation link.",rememberMe:"Remember me",forgotPassword:"Forgot password?",offerPrefix:"I have reviewed the",publicOffer:"public offer",googleSignIn:"Sign in with Google"},ru:{email:"Email",password:"Пароль",loginButton:"Войти",noAccount:"Нет аккаунта?",signUp:"Регистрация",errorInvalid:"Неверный email или пароль",errorFill:"Заполните все поля",emailNotConfirmed:"Сначала подтвердите ваш email. Проверьте входящие письма для перехода по ссылке подтверждения.",rememberMe:"Запомнить меня",forgotPassword:"Забыли пароль?",offerPrefix:"С",publicOffer:"публичной офертой",offerSuffix:"ознакомлен",googleSignIn:"Войти через Google"},de:{email:"E-Mail",password:"Passwort",loginButton:"Anmelden",noAccount:"Noch kein Konto?",signUp:"Registrieren",errorInvalid:"Ungültige E-Mail oder Passwort",errorFill:"Bitte füllen Sie alle Felder aus",emailNotConfirmed:"Bitte bestätigen Sie zuerst Ihre E-Mail. Überprüfen Sie Ihren Posteingang.",rememberMe:"Merken Sie sich mich",forgotPassword:"Passwort vergessen?",offerPrefix:"Ich habe das",publicOffer:"öffentliche Angebot",offerSuffix:"geprüft",googleSignIn:"Mit Google anmelden"},es:{email:"Email",password:"Contraseña",loginButton:"Iniciar sesión",noAccount:"¿No tienes cuenta?",signUp:"Registrarse",errorInvalid:"Email o contraseña inválidos",errorFill:"Por favor complete todos los campos",emailNotConfirmed:"Primero confirma tu email. Revisa tu bandeja de entrada.",rememberMe:"Recuérdame",forgotPassword:"¿Olvidaste tu contraseña?",offerPrefix:"He revisado la",publicOffer:"oferta pública",offerSuffix:"",googleSignIn:"Iniciar sesión con Google"},tr:{email:"E-mail",password:"Şifre",loginButton:"Giriş yap",noAccount:"Hesabınız yok mu?",signUp:"Kayıt ol",errorInvalid:"Geçersiz e-posta veya şifre",errorFill:"Lütfen tüm alanları doldurun",emailNotConfirmed:"Lütfen önce e-postanızı onaylayın. Gelen kutunuzu kontrol edin.",rememberMe:"Beni hatırlayın",forgotPassword:"Şifrenizi mi unuttunuz?",offerPrefix:"",publicOffer:"Halka açık teklifi",offerSuffix:"inceledim",googleSignIn:"Google ile giriş yap"}}[z],S=async v=>{if(v.preventDefault(),h(""),!t||!n){h(g.errorFill);return}if(!f){h(z==="ru"?"Необходимо согласиться с публичной офертой":z==="de"?"Sie müssen das öffentliche Angebot akzeptieren":z==="es"?"Debe aceptar la oferta pública":z==="tr"?"Kamu teklifini kabul etmelisiniz":"You must accept the public offer");return}p(!0);const A=await T(t,n,u);if(p(!1),A)P(!1),r();else{const C=E||"";C==="email_not_verified"||C.toLowerCase().includes("email not confirmed")||C.toLowerCase().includes("not confirmed")?(P(!0),h(g.emailNotConfirmed)):(P(!1),h(E||g.errorInvalid))}};return e.jsxs("form",{onSubmit:S,className:"space-y-5",children:[d&&e.jsxs(k.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},className:`px-4 py-3 rounded-xl flex items-start gap-2 ${I?"bg-amber-50 border border-amber-200 text-amber-800":"bg-red-50 border border-red-200 text-red-700"}`,children:[I?e.jsx(Ne,{className:"w-5 h-5 flex-shrink-0 mt-0.5"}):e.jsx(V,{className:"w-5 h-5 flex-shrink-0 mt-0.5"}),e.jsx("span",{className:"text-sm",children:d})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:g.email}),e.jsxs("div",{className:"relative",children:[e.jsx(ee,{className:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:"email",value:t,onChange:v=>o(v.target.value),className:"w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all",placeholder:"you@example.com"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:g.password}),e.jsxs("div",{className:"relative",children:[e.jsx(_,{className:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:y?"text":"password",value:n,onChange:v=>s(v.target.value),className:"w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all",placeholder:"••••••••"}),e.jsx("button",{type:"button",className:"absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400",onClick:()=>c(!y),children:y?e.jsx(q,{}):e.jsx(U,{})})]})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx("input",{type:"checkbox",id:"remember-me",checked:u,onChange:v=>w(v.target.checked),className:"h-4 w-4 text-[#D4522A] focus:ring-[#D4522A] border-gray-300 rounded cursor-pointer"}),e.jsx("label",{htmlFor:"remember-me",className:"ml-2 text-sm text-gray-600 cursor-pointer",children:g.rememberMe})]}),e.jsx("button",{type:"button",onClick:l,className:"text-sm text-[#D4522A] hover:text-[#EF6852] font-medium transition-colors",children:g.forgotPassword})]}),e.jsxs("div",{className:"flex items-start gap-3",children:[e.jsx("input",{type:"checkbox",id:"public-offer",checked:f,onChange:v=>N(v.target.checked),className:"h-4 w-4 text-[#D4522A] focus:ring-[#D4522A] border-gray-300 rounded cursor-pointer mt-0.5 flex-shrink-0"}),e.jsx("label",{htmlFor:"public-offer",className:"text-sm text-gray-600 cursor-pointer leading-tight",children:z==="ru"?e.jsxs(e.Fragment,{children:[g.offerPrefix," ",e.jsx("a",{href:"#",className:"text-[#D4522A] hover:text-[#EF6852] underline font-medium",children:g.publicOffer})," ",g.offerSuffix]}):z==="tr"?e.jsxs(e.Fragment,{children:[e.jsx("a",{href:"#",className:"text-[#D4522A] hover:text-[#EF6852] underline font-medium",children:g.publicOffer})," ",g.offerSuffix]}):e.jsxs(e.Fragment,{children:[g.offerPrefix," ",e.jsx("a",{href:"#",className:"text-[#D4522A] hover:text-[#EF6852] underline font-medium",children:g.publicOffer})," ",g.offerSuffix]})})]}),e.jsx(k.button,{type:"submit",disabled:m,whileHover:{scale:m?1:1.02},whileTap:{scale:m?1:.98},className:"w-full py-3 bg-gradient-to-r from-[#D4522A] to-[#E8744F] text-white rounded-xl font-medium shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed",children:m?"...":g.loginButton}),e.jsxs("div",{className:"text-center pt-4",children:[e.jsxs("span",{className:"text-gray-600 text-sm",children:[g.noAccount," "]}),e.jsx("button",{type:"button",onClick:a,className:"text-[#D4522A] font-medium text-sm hover:underline",children:g.signUp})]})]})}function We({onSuccess:r,onSwitchToLogin:a}){const[l,t]=i.useState(""),[o,n]=i.useState(""),[s,d]=i.useState(""),[h,m]=i.useState(""),[p,y]=i.useState(""),[c,u]=i.useState(!1),[w,f]=i.useState(!1),[N,I]=i.useState(!1),[P,T]=i.useState(""),[E,z]=i.useState(!1),[b,g]=i.useState(!1),[S,v]=i.useState(!1),[A,C]=i.useState(!1),{register:O,resendConfirmationEmail:ae,authError:M}=R(),{language:W}=B(),x={en:{firstName:"Name",lastName:"Last name",email:"Email",password:"Password",confirmPassword:"Confirm password",registerButton:"Create account",haveAccount:"Already have an account?",logIn:"Log in",errorFill:"Please fill in all fields",errorPassword:"Passwords do not match",errorPasswordLength:"Password must be at least 8 characters and contain letters and numbers",errorExists:"This email is already registered",errorTerms:"You must agree to the terms and conditions",agreeText:"I agree to",termsOfService:"Terms & Conditions",and:" / ",privacyPolicy:"Privacy Policy",googleSignIn:"Sign in with Google",confirmTitle:"Check your email",confirmMessage:"We sent a confirmation link to",confirmHint:"Click the link in the email to activate your account. After confirmation, you can log in.",resendButton:"Resend email",resendSuccess:"Email sent!",backToLogin:"Go to login",checkSpam:"Check your spam folder if you don't see the email."},ru:{firstName:"Имя",lastName:"Фамилия",email:"Email",password:"Пароль",confirmPassword:"Подтвердите пароль",registerButton:"Создать аккаунт",haveAccount:"Уже есть аккаунт?",logIn:"Войти",errorFill:"Заполните все поля",errorPassword:"Пароли не совпадают",errorPasswordLength:"Пароль должен содержать минимум 8 символов, буквы и цифры",errorExists:"Этот email уже зарегистрирован",errorTerms:"Вы должны согласиться с условиями",agreeText:"Я согласен с",termsOfService:"Условиями использования",and:"и",privacyPolicy:"Политикой конфиденциальности",googleSignIn:"Войти через Google",confirmTitle:"Проверьте вашу почту",confirmMessage:"Мы отправили ссылку для подтверждения на",confirmHint:"Перейдите по ссылке в письме, чтобы активировать аккаунт. После подтверждения вы сможете войти.",resendButton:"Отправить повторно",resendSuccess:"Письмо отправлено!",backToLogin:"Перейти к входу",checkSpam:"Проверьте папку «Спам», если не видите письмо."},de:{firstName:"Name",lastName:"Nachname",email:"E-Mail",password:"Passwort",confirmPassword:"Passwort bestätigen",registerButton:"Konto erstellen",haveAccount:"Haben Sie bereits ein Konto?",logIn:"Anmelden",errorFill:"Bitte füllen Sie alle Felder aus",errorPassword:"Passwörter stimmen nicht überein",errorPasswordLength:"Passwort muss mindestens 8 Zeichen lang sein und Buchstaben und Zahlen enthalten",errorExists:"Diese E-Mail ist bereits registriert",errorTerms:"Sie müssen den Bedingungen zustimmen",agreeText:"Ich stimme den",termsOfService:"Nutzungsbedingungen",and:" / ",privacyPolicy:"Datenschutzbestimmungen zu",googleSignIn:"Mit Google anmelden",confirmTitle:"Prüfen Sie Ihre E-Mail",confirmMessage:"Wir haben einen Bestätigungslink gesendet an",confirmHint:"Klicken Sie auf den Link in der E-Mail, um Ihr Konto zu aktivieren. Nach der Bestätigung können Sie sich anmelden.",resendButton:"E-Mail erneut senden",resendSuccess:"E-Mail gesendet!",backToLogin:"Zur Anmeldung",checkSpam:"Überprüfen Sie Ihren Spam-Ordner, falls Sie die E-Mail nicht sehen."},es:{firstName:"Nombre",lastName:"Apellido",email:"Email",password:"Contraseña",confirmPassword:"Confirmar contraseña",registerButton:"Crear cuenta",haveAccount:"¿Ya tienes una cuenta?",logIn:"Acceder",errorFill:"Por favor complete todos los campos",errorPassword:"Las contraseñas no coinciden",errorPasswordLength:"La contraseña debe tener al menos 8 caracteres y contener letras y números",errorExists:"Este email ya está registrado",errorTerms:"Debe aceptar los términos y condiciones",agreeText:"Acepto los",termsOfService:"Términos de Servicio",and:"y la",privacyPolicy:"Política de Privacidad",googleSignIn:"Iniciar sesión con Google",confirmTitle:"Revisa tu correo",confirmMessage:"Enviamos un enlace de confirmación a",confirmHint:"Haz clic en el enlace del correo para activar tu cuenta. Después de la confirmación, podrás iniciar sesión.",resendButton:"Reenviar correo",resendSuccess:"Correo enviado!",backToLogin:"Ir al inicio de sesión",checkSpam:"Revisa tu carpeta de spam si no ves el correo."},tr:{firstName:"Ad",lastName:"Soyadı",email:"E-mail",password:"Şifre",confirmPassword:"Şifreyi doğrulayın",registerButton:"Hesap oluştur",haveAccount:"Zaten bir hesabınız var mı?",logIn:"Giriş yap",errorFill:"Lütfen tüm alanları doldurun",errorPassword:"Şifreler eşleşmiyor",errorPasswordLength:"Şifre en az 8 karakter olmalı ve harf ve rakam içermelidir",errorExists:"Bu e-posta zaten kayıtlı",errorTerms:"Şartları ve koşulları kabul etmelisiniz",agreeText:"",termsOfService:"Kullanım Şartları'nı",and:"ve",privacyPolicy:"Gizlilik Politikası'nı kabul ediyorum",googleSignIn:"Google ile giriş yap",confirmTitle:"E-postanızı kontrol edin",confirmMessage:"Onay bağlantısı gönderildi:",confirmHint:"Hesabınızı etkinleştirmek için e-postadaki bağlantıya tıklayın. Onaydan sonra giriş yapabilirsiniz.",resendButton:"Tekrar gönder",resendSuccess:"E-posta gönderildi!",backToLogin:"Girişe git",checkSpam:"E-postayı görmüyorsanız spam klasörünüzü kontrol edin."}}[W],ve=async()=>{v(!0),C(!1);const D=await ae(s,W);v(!1),D&&(C(!0),setTimeout(()=>C(!1),5e3))},be=async D=>{if(D.preventDefault(),T(""),!l||!o||!s||!h||!p){T(x.errorFill);return}const ke=/[a-zA-Zа-яА-Я]/.test(h),we=/\d/.test(h);if(h.length<8||!ke||!we){T(x.errorPasswordLength);return}if(h!==p){T(x.errorPassword);return}if(!N){T(x.errorTerms);return}const xe=new URLSearchParams(window.location.search).get("ref")||void 0;z(!0);const re=await O(s,h,l,o,W,xe);z(!1),re==="success"?r():re==="confirmation_needed"?g(!0):T(M||x.errorExists)};return b?e.jsxs(k.div,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},className:"text-center py-4",children:[e.jsx("div",{className:"w-16 h-16 mx-auto mb-4 bg-green-100 rounded-full flex items-center justify-center",children:e.jsx(De,{className:"w-8 h-8 text-green-600"})}),e.jsx("h3",{className:"text-xl font-bold text-gray-900 mb-2",children:x.confirmTitle}),e.jsx("p",{className:"text-sm text-gray-600 mb-1",children:x.confirmMessage}),e.jsx("p",{className:"text-sm font-semibold text-[#D4522A] mb-4",children:s}),e.jsx("p",{className:"text-sm text-gray-500 mb-6",children:x.confirmHint}),e.jsx("p",{className:"text-xs text-gray-400 mb-6",children:x.checkSpam}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("button",{type:"button",onClick:ve,disabled:S,className:"w-full py-3 border-2 border-[#D4522A] text-[#D4522A] rounded-xl font-medium hover:bg-orange-50 transition-all disabled:opacity-50 flex items-center justify-center gap-2",children:[e.jsx(Pe,{className:`w-4 h-4 ${S?"animate-spin":""}`}),A?x.resendSuccess:x.resendButton]}),e.jsx("button",{type:"button",onClick:a,className:"w-full py-3 bg-gradient-to-r from-[#D4522A] to-[#E8744F] text-white rounded-xl font-medium shadow-lg shadow-orange-500/30 hover:shadow-xl transition-all",children:x.backToLogin})]})]}):e.jsxs("form",{onSubmit:be,className:"space-y-4",children:[P&&e.jsxs(k.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},className:"bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center gap-2",children:[e.jsx(V,{className:"w-5 h-5 flex-shrink-0"}),e.jsx("span",{className:"text-sm",children:P})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:x.firstName}),e.jsxs("div",{className:"relative",children:[e.jsx(ze,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:"text",value:l,onChange:D=>t(D.target.value),className:"w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"John"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:x.lastName}),e.jsx("input",{type:"text",value:o,onChange:D=>n(D.target.value),className:"w-full px-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"Doe"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:x.email}),e.jsxs("div",{className:"relative",children:[e.jsx(ee,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:"email",value:s,onChange:D=>d(D.target.value),className:"w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"you@example.com"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:x.password}),e.jsxs("div",{className:"relative",children:[e.jsx(_,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:c?"text":"password",value:h,onChange:D=>m(D.target.value),className:"w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"••••••••"}),e.jsx("button",{type:"button",className:"absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400",onClick:()=>u(!c),children:c?e.jsx(q,{}):e.jsx(U,{})})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:x.confirmPassword}),e.jsxs("div",{className:"relative",children:[e.jsx(X,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:w?"text":"password",value:p,onChange:D=>y(D.target.value),className:"w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"••••••••"}),e.jsx("button",{type:"button",className:"absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400",onClick:()=>f(!w),children:w?e.jsx(q,{}):e.jsx(U,{})})]})]}),e.jsxs("div",{className:"flex items-center",children:[e.jsx("input",{type:"checkbox",checked:N,onChange:D=>I(D.target.checked),className:"w-4 h-4 text-[#D4522A] bg-gray-100 border-gray-300 rounded focus:ring-[#D4522A] focus:ring-2"}),e.jsxs("label",{className:"ml-2 text-sm text-gray-700",children:[x.agreeText," ",e.jsx("a",{href:"#",className:"text-[#D4522A]",children:x.termsOfService})," ",x.and," ",e.jsx("a",{href:"#",className:"text-[#D4522A]",children:x.privacyPolicy})]})]}),e.jsx(k.button,{type:"submit",disabled:E,whileHover:{scale:E?1:1.02},whileTap:{scale:E?1:.98},className:"w-full py-3 bg-gradient-to-r from-[#D4522A] to-[#E8744F] text-white rounded-xl font-medium shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed",children:E?"...":x.registerButton}),e.jsxs("div",{className:"text-center pt-2",children:[e.jsxs("span",{className:"text-gray-600 text-sm",children:[x.haveAccount," "]}),e.jsx("button",{type:"button",onClick:a,className:"text-[#D4522A] font-medium text-sm hover:underline",children:x.logIn})]})]})}function Qe({onSuccess:r,onBack:a}){const[l,t]=i.useState(""),[o,n]=i.useState(""),[s,d]=i.useState(""),[h,m]=i.useState(!1),{resetPassword:p,authError:y}=R(),{language:c}=B(),w={en:{title:"Reset Password",email:"Email",resetButton:"Send Reset Link",backToLogin:"Back to Login",errorFill:"Please enter your email",errorNotFound:"Could not send reset email",successMessage:"A password reset link has been sent to your email. Please check your inbox."},ru:{title:"Сброс пароля",email:"Email",resetButton:"Отправить ссылку для сброса",backToLogin:"Назад к входу",errorFill:"Введите ваш email",errorNotFound:"Не удалось отправить письмо для сброса",successMessage:"Ссылка для сброса пароля отправлена на вашу почту. Проверьте входящие."},de:{title:"Passwort zurücksetzen",email:"E-Mail",resetButton:"Link zum Zurücksetzen senden",backToLogin:"Zurück zur Anmeldung",errorFill:"Bitte geben Sie Ihre E-Mail ein",errorNotFound:"Reset-E-Mail konnte nicht gesendet werden",successMessage:"Ein Link zum Zurücksetzen des Passworts wurde an Ihre E-Mail gesendet."},es:{title:"Restablecer contraseña",email:"Email",resetButton:"Enviar enlace de restablecimiento",backToLogin:"Volver al inicio de sesión",errorFill:"Por favor ingrese su email",errorNotFound:"No se pudo enviar el correo de restablecimiento",successMessage:"Se ha enviado un enlace para restablecer su contraseña a su correo electrónico."},tr:{title:"Şifre sıfırlama",email:"E-mail",resetButton:"Sıfırlama bağlantısı gönder",backToLogin:"Girişe geri dön",errorFill:"Lütfen e-postanızı girin",errorNotFound:"Sıfırlama e-postası gönderilemedi",successMessage:"Şifre sıfırlama bağlantısı e-postanıza gönderildi."}}[c],f=async N=>{if(N.preventDefault(),n(""),d(""),!l){n(w.errorFill);return}m(!0);const I=await p(l,"",c);m(!1),I?(d(w.successMessage),setTimeout(()=>{r()},4e3)):n(y||w.errorNotFound)};return e.jsx("div",{className:"space-y-4",children:e.jsxs("form",{onSubmit:f,className:"space-y-4",children:[o&&e.jsxs(k.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},className:"bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center gap-2",children:[e.jsx(V,{className:"w-5 h-5 flex-shrink-0"}),e.jsx("span",{className:"text-sm",children:o})]}),s&&e.jsxs(k.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},className:"bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl flex items-center gap-2",children:[e.jsx(X,{className:"w-5 h-5 flex-shrink-0"}),e.jsx("span",{className:"text-sm",children:s})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:w.email}),e.jsxs("div",{className:"relative",children:[e.jsx(ee,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),e.jsx("input",{type:"email",value:l,onChange:N=>t(N.target.value),className:"w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4522A] focus:border-transparent transition-all text-sm",placeholder:"you@example.com"})]})]}),e.jsx(k.button,{type:"submit",disabled:h,whileHover:{scale:h?1:1.02},whileTap:{scale:h?1:.98},className:"w-full py-3 bg-gradient-to-r from-[#D4522A] to-[#E8744F] text-white rounded-xl font-medium shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed",children:h?"...":w.resetButton}),e.jsx("div",{className:"text-center pt-2",children:e.jsx("button",{type:"button",onClick:a,className:"text-[#D4522A] font-medium text-sm hover:underline",children:w.backToLogin})})]})})}function fe({isOpen:r,onClose:a,mode:l="login",onAuthSuccess:t}){const[o,n]=i.useState(l),{language:s}=B();i.useEffect(()=>{r&&n(l)},[r,l]);const d={en:{login:"Log in",register:"Registration",reset:"Reset Password"},ru:{login:"Войти",register:"Регистрация",reset:"Восстановление пароля"},de:{login:"Anmelden",register:"Registrieren",reset:"Passwort wiederherstellen"},es:{login:"Acceder",register:"Registrarse",reset:"Restablecer contraseña"},tr:{login:"Giriş yap",register:"Kayıt ol",reset:"Parolayı sıfırla"}},h={en:{login:"Enter your credentials to access your partner dashboard"},ru:{login:"Введите свои учетные данные для доступа к панели управления партнера"},de:{login:"Geben Sie Ihre Zugangsdaten ein, um auf Ihr Partner-Dashboard zuzugreifen"},es:{login:"Introduce tus credenciales para acceder a tu panel de socio"},tr:{login:"Ortak panelinize erişmek için kimlik bilgilerinizi girin"}};return e.jsx(G,{children:r&&e.jsxs(e.Fragment,{children:[e.jsx(k.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:a,className:"fixed inset-0 bg-black/60 backdrop-blur-sm z-50"}),e.jsx("div",{className:"fixed inset-0 flex items-center justify-center z-50 p-4",children:e.jsxs(k.div,{initial:{opacity:0,scale:.95,y:20},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:20},className:"bg-[var(--color-surface)] rounded-3xl shadow-2xl w-full max-w-md relative overflow-hidden",onClick:m=>m.stopPropagation(),children:[e.jsx("button",{onClick:a,className:"absolute top-6 right-6 text-[var(--color-text-secondary)] hover:text-[var(--color-text)] transition-colors z-10",children:e.jsx(J,{className:"w-6 h-6"})}),e.jsxs("div",{className:"p-8",children:[e.jsx("h2",{className:"text-3xl font-bold text-[var(--color-text)] mb-2",children:d[s][o]}),o==="login"&&e.jsx("p",{className:"text-sm text-[var(--color-text-secondary)] mb-6",children:h[s][o]}),o==="login"?e.jsx(Ve,{onSuccess:t||a,onSwitchToRegister:()=>n("register"),onSwitchToReset:()=>n("reset")}):o==="register"?e.jsx(We,{onSuccess:t||a,onSwitchToLogin:()=>n("login")}):e.jsx(Qe,{onSuccess:()=>n("login"),onBack:()=>n("login")})]})]})})]})})}function ge({isOpen:r,onClose:a,onLoginClick:l,onSignInClick:t,handleLoginClick:o,handleSignInClick:n}){const{language:s}=B(),d=te[s],h=l||o||(()=>{}),m=t||n||(()=>{}),p=[{id:"unique-features",label:d.features},{id:"opportunities",label:d.aboutUs},{id:"partnership",label:d.forPartners},{id:"investments",label:d.stagesOfDevelopment},{id:"advantages",label:d.whyChefNet},{id:"roadmap",label:d.roadmap},{id:"faq",label:d.faq},{id:"team",label:d.team},{id:"footer",label:d.contacts}],y=c=>{const u=document.getElementById(c);u&&(u.scrollIntoView({behavior:"smooth"}),a())};return e.jsx(G,{children:r&&e.jsxs(e.Fragment,{children:[e.jsx(k.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:a,className:"fixed inset-0 bg-black/50 backdrop-blur-sm z-50"}),e.jsxs(k.div,{initial:{x:"100%"},animate:{x:0},exit:{x:"100%"},transition:{type:"spring",damping:30,stiffness:300},className:"fixed top-0 right-0 bottom-0 w-[280px] bg-white z-50 shadow-2xl overflow-y-auto",children:[e.jsxs("div",{className:"flex items-center justify-between p-4 border-b border-gray-200",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(K,{className:"w-5 h-5 text-[#FF6B35]"}),e.jsxs("span",{className:"font-bold text-lg",children:["ChefNet ",e.jsx("span",{className:"text-[#FF6B35]",children:"Invest"})]})]}),e.jsx("button",{onClick:a,className:"p-2 rounded-lg hover:bg-gray-100 transition-colors",children:e.jsx(J,{className:"w-6 h-6"})})]}),e.jsxs("nav",{className:"p-4",children:[e.jsx("ul",{className:"space-y-2",children:p.map(c=>e.jsx("li",{children:e.jsx("button",{onClick:()=>y(c.id),className:"w-full text-left px-4 py-3 rounded-lg hover:bg-gray-100 transition-colors text-[#3E3E3E] font-medium",children:c.label})},c.id))}),e.jsxs("div",{className:"mt-6 space-y-3 px-4",children:[e.jsx("button",{onClick:()=>{h(),a()},className:"w-full py-3 px-4 bg-[#FF6B35] text-white rounded-full font-medium hover:bg-[#FF8C42] transition-colors",children:d.logIn}),e.jsx("button",{onClick:()=>{m(),a()},className:"w-full py-3 px-4 border-2 border-[#FF6B35] text-[#FF6B35] rounded-full font-medium hover:bg-[#FF6B35] hover:text-white transition-colors",children:d.signIn})]})]})]})]})})}const He="/assets/ea3684a8e6ad5b9f30bbc761f606c383abcbe400.webp",Ye="/assets/f6e6a7c1827ce38e56117c96836c20e4665523fd.webp";function Ze({onGoToDashboard:r}){const{language:a}=B(),{isAuthenticated:l}=R(),t=i.useMemo(()=>te[a],[a]),[o,n]=i.useState(!1),[s,d]=i.useState("login"),[h,m]=i.useState(!1),p=()=>{l?r():(d("login"),n(!0))},y=()=>{l?r():(d("register"),n(!0))},c=()=>{n(!1),setTimeout(()=>{r()},300)};return e.jsxs("section",{id:"home",className:"relative bg-background px-4 pb-8 pt-6 sm:px-6 md:px-8",children:[e.jsxs("div",{className:"hidden md:block relative overflow-hidden",style:{height:"auto",minHeight:"620px",borderRadius:"32px",background:"#5A2F23"},children:[e.jsx("div",{className:"relative z-10 px-8 py-4",children:e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsxs("button",{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),className:"flex items-center gap-1.5 flex-shrink-0",children:[e.jsx(K,{className:"w-5 h-5 text-[#FF6B35] drop-shadow-[0_2px_8px_rgba(255,107,53,0.5)]"}),e.jsxs("div",{className:"whitespace-nowrap",children:[e.jsxs("span",{className:"font-semibold text-[15px] text-white tracking-tight drop-shadow-[0_2px_8px_rgba(255,255,255,0.5)]",children:["ChefNet"," "]}),e.jsx("span",{className:"font-semibold text-[15px] tracking-tight drop-shadow-[0_2px_6px_rgba(255,107,53,0.4)]",style:{color:"#FF6B35"},children:"Invest"})]})]}),e.jsxs("nav",{className:"hidden lg:flex items-center gap-4 flex-1 justify-center",children:[e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("unique-features"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.features}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("opportunities"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.aboutUs}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("partnership"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.forPartners}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("investments"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.stagesOfDevelopment}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("advantages"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.whyChefNet}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("roadmap"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.roadmap}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("faq"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.faq}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("team"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.team}),e.jsx("button",{onClick:()=>{var u;return(u=document.getElementById("footer"))==null?void 0:u.scrollIntoView({behavior:"smooth"})},className:"text-white hover:text-white text-[12px] font-medium transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_2px_10px_rgba(255,255,255,0.6)]",children:t.contacts})]}),e.jsxs("div",{className:"flex items-center gap-2 flex-shrink-0",children:[e.jsx("div",{className:"mr-4",children:e.jsx($,{})}),e.jsx(k.button,{whileHover:{scale:1.03},whileTap:{scale:.97},className:"px-3.5 bg-white/10 text-white rounded-full text-[12px] font-medium hover:bg-white/15 transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)]",style:{borderColor:"rgba(255, 107, 53, 0.5)",borderWidth:"1px",borderStyle:"solid"},onClick:p,children:t.logIn}),e.jsx(k.button,{whileHover:{scale:1.03},whileTap:{scale:.97},className:"px-3.5 bg-white/10 text-white rounded-full text-[12px] font-medium hover:bg-white/15 transition-all whitespace-nowrap drop-shadow-[0_2px_6px_rgba(255,255,255,0.4)]",style:{borderColor:"rgba(255, 107, 53, 0.5)",borderWidth:"1px",borderStyle:"solid"},onClick:y,children:t.signIn})]})]})}),e.jsx("div",{className:"relative z-10 flex-1 flex items-center justify-start px-8 pt-20 pb-8",children:e.jsxs("div",{className:"w-full max-w-[40%] pr-10",children:[e.jsxs(k.h1,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2},className:"text-white font-bold text-[42px] leading-tight mb-5",style:{letterSpacing:"-0.02em",fontFamily:"Montserrat, sans-serif"},children:[e.jsxs("span",{className:"inline-block relative",style:{position:"relative"},children:[e.jsx("span",{style:{position:"absolute",left:"-10px",right:"-10px",top:"-6px",bottom:"-6px",background:"linear-gradient(135deg, #FF8B5A 0%, #FF7645 50%, #FF6B35 100%)",borderRadius:"18px",zIndex:-1,boxShadow:"0 0 40px 15px rgba(255, 107, 53, 0.4), 0 0 80px 30px rgba(255, 107, 53, 0.2)",filter:"blur(2px)"}}),e.jsx("span",{style:{position:"relative",zIndex:1},children:a==="ru"?"Интеллект,":a==="en"?"Intelligence":a==="de"?"Intelligenz,":a==="es"?"Inteligencia":"Seçimi"})]}),e.jsx("br",{}),a==="ru"?"превращающий":a==="en"?"that turns":a==="de"?"die Auswahl":a==="es"?"que convierte":"değere çeviren",e.jsx("br",{}),a==="ru"?"выбор в ценность.":a==="en"?"choice into value.":a==="de"?"in Wert verwandelt.":a==="es"?"la elección en valor.":"zekâ."]}),e.jsxs(k.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.4},className:"text-white text-[14px] leading-relaxed mb-6",children:[e.jsx("p",{className:"font-bold mb-2",style:{fontFamily:"Nunito, sans-serif"},children:t.heroSubtitle}),e.jsx("p",{className:"font-normal opacity-90 mb-4",children:a==="ru"?e.jsxs(e.Fragment,{children:["которая изучает ваш ритм, запоминает ваш вкус и сохраняет вам",e.jsx("br",{}),"время и деньги каждый день."]}):t.heroDescription}),e.jsx("p",{className:"font-normal opacity-90 mb-1",children:t.heroBenefit1}),e.jsx("p",{className:"font-normal opacity-90 mb-1",children:t.heroBenefit2}),e.jsx("p",{className:"font-normal opacity-90 mb-4",children:t.heroBenefit3}),e.jsx("p",{className:"font-normal opacity-90",children:t.heroCta})]})]})}),e.jsx("img",{src:He,alt:"Food",loading:"eager",decoding:"async",className:"absolute top-0 bottom-0 h-full w-full object-cover z-0",style:{right:"-12%",objectPosition:"right center",opacity:1,filter:"brightness(1.1) contrast(1.2) saturate(1.15)",maskImage:"linear-gradient(to left, rgba(0,0,0,1) 30%, rgba(0,0,0,0.8) 60%, rgba(0,0,0,0.3) 85%, transparent 100%)",WebkitMaskImage:"linear-gradient(to left, rgba(0,0,0,1) 30%, rgba(0,0,0,0.8) 60%, rgba(0,0,0,0.3) 85%, transparent 100%)"}})]}),e.jsxs("div",{className:"md:hidden overflow-hidden relative",style:{borderRadius:"32px",minHeight:"780px"},children:[e.jsx("div",{className:"absolute inset-0 z-0",style:{backgroundImage:`url(${Ye})`,backgroundSize:"cover",backgroundPosition:"center center",filter:"brightness(1.0) contrast(1.1) saturate(1.1)"}}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("div",{className:"px-4 py-3",children:e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsxs("button",{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),className:"flex items-center gap-1 flex-shrink-0",children:[e.jsx(K,{className:"w-4 h-4 text-[#FF6B35] drop-shadow-[0_2px_8px_rgba(255,107,53,0.5)]"}),e.jsxs("div",{className:"whitespace-nowrap",children:[e.jsxs("span",{className:"font-semibold text-[13px] text-white tracking-tight drop-shadow-[0_2px_8px_rgba(255,255,255,0.5)]",children:["ChefNet"," "]}),e.jsx("span",{className:"font-semibold text-[13px] tracking-tight drop-shadow-[0_2px_6px_rgba(255,107,53,0.4)]",style:{color:"#FF6B35"},children:"Invest"})]})]}),e.jsxs("div",{className:"flex items-center gap-2 flex-shrink-0",children:[e.jsx($,{}),e.jsx("button",{onClick:()=>m(!0),className:"p-2 text-white hover:bg-white/10 rounded-lg transition-colors",children:e.jsx(ue,{className:"w-5 h-5"})})]})]})}),e.jsxs("div",{className:"relative z-10 px-4 py-8 pb-12",children:[e.jsxs(k.h1,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2},className:"text-white font-bold text-[28px] sm:text-[36px] leading-tight mb-3",style:{letterSpacing:"-0.02em",fontFamily:"Montserrat, sans-serif"},children:[e.jsxs("span",{className:"inline-block relative",style:{position:"relative"},children:[e.jsx("span",{style:{position:"absolute",left:"-10px",right:"-10px",top:"-6px",bottom:"-6px",background:"linear-gradient(135deg, #FF8B5A 0%, #FF7645 50%, #FF6B35 100%)",borderRadius:"18px",zIndex:-1,boxShadow:"0 0 40px 15px rgba(255, 107, 53, 0.4), 0 0 80px 30px rgba(255, 107, 53, 0.2)",filter:"blur(2px)"}}),e.jsx("span",{style:{position:"relative",zIndex:1},children:t.heroTitle3})]})," ",t.heroTitle4]}),e.jsxs(k.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.4},className:"text-white text-[13px] leading-snug mb-4",children:[e.jsxs("div",{className:"mb-2",children:[e.jsx("p",{className:"font-bold mb-0.5",style:{fontFamily:"Nunito, sans-serif"},children:t.heroSubtitle}),e.jsx("p",{className:"font-normal opacity-90",children:t.heroDescription})]}),e.jsxs("div",{className:"mb-2 font-normal opacity-90",children:[e.jsx("p",{className:"mb-0",children:t.heroBenefit1}),e.jsx("p",{className:"mb-0",children:t.heroBenefit2}),e.jsx("p",{className:"mb-0",children:t.heroBenefit3})]}),e.jsx("p",{className:"font-normal opacity-90",children:t.heroCta})]}),e.jsx(k.button,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.6},whileHover:{scale:1.03},whileTap:{scale:.97},className:"w-full max-w-xs px-6 py-3 bg-white text-[#FF6B35] rounded-full text-sm font-bold transition-all shadow-lg hover:shadow-xl",onClick:y,children:t.logIn})]})]})]}),e.jsx(fe,{isOpen:o,onClose:()=>n(!1),mode:s,onAuthSuccess:c}),e.jsx(ge,{isOpen:h,onClose:()=>m(!1),onLoginClick:p,onSignInClick:y})]})}function $e({onGoToDashboard:r}){const{language:a}=B(),{isAuthenticated:l}=R(),t=te[a],[o,n]=i.useState(!1),[s,d]=i.useState("login"),[h,m]=i.useState(!1),[p,y]=i.useState(!1);i.useRef(null),i.useEffect(()=>{const f=document.getElementById("home");if(!f){console.log("❌ Hero section not found");return}const N=new IntersectionObserver(([I])=>{const P=!I.isIntersecting;console.log("👁️ Hero visible:",I.isIntersecting,"| Sticky nav visible:",P),m(P)},{threshold:.1,rootMargin:"-80px 0px 0px 0px"});return N.observe(f),()=>{N.disconnect()}},[]);const c=()=>{l?r():(d("login"),n(!0))},u=()=>{l?r():(d("register"),n(!0))},w=()=>{n(!1),setTimeout(()=>{r()},300)};return e.jsxs(e.Fragment,{children:[e.jsx(k.div,{initial:{y:-100,opacity:0},animate:{y:h?0:-100,opacity:h?1:0},transition:{duration:.3,ease:"easeOut"},className:`fixed top-0 left-0 right-0 z-50 backdrop-blur-md shadow-lg ${h?"pointer-events-auto":"pointer-events-none"}`,style:{backgroundColor:"rgba(233, 222, 214, 0.85)"},children:e.jsx("div",{className:"px-8 py-4",children:e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsxs("button",{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),className:"flex items-center gap-1.5 flex-shrink-0",children:[e.jsx(K,{className:"w-5 h-5 text-[#FF6B35]"}),e.jsxs("div",{className:"whitespace-nowrap",children:[e.jsxs("span",{className:"font-semibold text-[15px] text-[#2C1810] tracking-tight",children:["ChefNet"," "]}),e.jsx("span",{className:"font-semibold text-[15px] tracking-tight",style:{color:"#D93F29"},children:"Invest"})]})]}),e.jsx("div",{className:"hidden lg:block flex-1",children:e.jsxs("nav",{className:"flex items-center justify-center gap-6",children:[e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("unique-features"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.features}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("opportunities"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.aboutUs}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("partnership"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.forPartners}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("investments"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.stagesOfDevelopment}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("advantages"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.whyChefNet}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("roadmap"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.roadmap}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("faq"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.faq}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("team"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.team}),e.jsx("button",{onClick:()=>{var f;return(f=document.getElementById("footer"))==null?void 0:f.scrollIntoView({behavior:"smooth"})},className:"text-[#3E3E3E] hover:text-[#FF6B35] text-[12px] font-medium transition-all whitespace-nowrap",children:t.contacts})]})}),e.jsxs("div",{className:"flex items-center gap-1.5 flex-shrink-0",children:[e.jsx("div",{className:"mr-4",children:e.jsx($,{variant:"dark"})}),e.jsx("button",{onClick:()=>y(!0),className:"lg:hidden p-2 text-[#6B4423] hover:bg-[#6B4423]/10 rounded-lg transition-colors",children:e.jsx(ue,{className:"w-5 h-5"})}),e.jsx(k.button,{whileHover:{scale:1.03},whileTap:{scale:.97},className:"hidden sm:block px-3 py-1.5 text-[#D93F29] rounded-full text-[12px] font-medium hover:bg-[#D93F29]/10 transition-all whitespace-nowrap",style:{borderColor:"#D93F29",borderWidth:"1px",borderStyle:"solid"},onClick:c,children:t.logIn}),e.jsx(k.button,{whileHover:{scale:1.03},whileTap:{scale:.97},className:"hidden sm:block px-3 py-1.5 text-[#D93F29] rounded-full text-[12px] font-medium hover:bg-[#D93F29]/10 transition-all whitespace-nowrap",style:{borderColor:"#D93F29",borderWidth:"1px",borderStyle:"solid"},onClick:u,children:t.signIn})]})]})})}),e.jsx(fe,{isOpen:o,onClose:()=>n(!1),mode:s,onAuthSuccess:w}),e.jsx(ge,{isOpen:p,onClose:()=>y(!1),onGoToDashboard:r,isAuthenticated:l,handleLoginClick:c,handleSignInClick:u})]})}const Je=i.lazy(()=>j(()=>import("./AboutSection-C_l30FhG.js"),__vite__mapDeps([0,1,2,3,4]))),Xe=i.lazy(()=>j(()=>import("./UniqueFeaturesSection-DN3xK_XS.js"),__vite__mapDeps([5,2,3,6,1,4]))),en=i.lazy(()=>j(()=>import("./OpportunitiesSection-DlE7FPfX.js"),__vite__mapDeps([7,2,3,6,1,4]))),nn=i.lazy(()=>j(()=>import("./PartnershipSection-BKXBXgQw.js"),__vite__mapDeps([8,2,3,6,1,4]))),tn=i.lazy(()=>j(()=>import("./InvestmentsSection-DlRB64Mg.js"),__vite__mapDeps([9,2,3,6,1,4]))),an=i.lazy(()=>j(()=>import("./AdvantagesSection-D4FUbau9.js"),__vite__mapDeps([10,2,3,6,1,4]))),rn=i.lazy(()=>j(()=>import("./RoadmapSection-CSoKHkuT.js"),__vite__mapDeps([11,2,3,6,1,4]))),sn=i.lazy(()=>j(()=>import("./ChefNetAppSection-COuVXblN.js"),__vite__mapDeps([12,2,3,4,1]))),on=i.lazy(()=>j(()=>import("./FAQSection-CtvUyb13.js"),__vite__mapDeps([13,2,3,6,1,4]))),ln=i.lazy(()=>j(()=>import("./CTABanner-B8FhOCbc.js"),__vite__mapDeps([14,2,3,4,1]))),cn=i.lazy(()=>j(()=>import("./TeamSection-9gPnkrUI.js"),__vite__mapDeps([15,2,3,6,4,1]))),dn=i.lazy(()=>j(()=>import("./Footer-TaQW4LqQ.js"),__vite__mapDeps([16,2,3,1,4]))),un=i.lazy(()=>j(()=>import("./Dashboard-BYv4tR1c.js"),__vite__mapDeps([17,2,3,18,1,19,20,4]))),de={en:"Email confirmed! You can now log in.",ru:"Email подтверждён! Теперь вы можете войти.",de:"E-Mail bestätigt! Sie können sich jetzt anmelden.",es:"Email confirmado! Ahora puedes iniciar sesión.",tr:"E-posta onaylandı! Artık giriş yapabilirsiniz."},L={invalid:{en:"Verification link is invalid. Please request a new one.",ru:"Ссылка для подтверждения недействительна. Запросите новую.",de:"Bestätigungslink ist ungültig. Bitte fordern Sie einen neuen an.",es:"El enlace de verificación no es válido. Solicite uno nuevo.",tr:"Doğrulama bağlantısı geçersiz. Lütfen yeni bir tane isteyin."},expired:{en:"Verification link has expired. Please request a new one.",ru:"Ссылка для подтверждения истекла. Запросите новую.",de:"Bestätigungslink ist abgelaufen. Bitte fordern Sie einen neuen an.",es:"El enlace de verificación ha expirado. Solicite uno nuevo.",tr:"Doğrulama bağlantısının süresi doldu. Lütfen yeni bir tane isteyin."},server:{en:"A server error occurred. Please try again later.",ru:"Произошла ошибка сервера. Попробуйте позже.",de:"Ein Serverfehler ist aufgetreten. Bitte versuchen Sie es später erneut.",es:"Ocurrió un error del servidor. Inténtelo de nuevo más tarde.",tr:"Bir sunucu hatası oluştu. Lütfen daha sonra tekrar deneyin."},missing:{en:"Verification link is incomplete. Please use the full link from the email.",ru:"Ссылка для подтверждения неполная. Используйте полную ссылку из письма.",de:"Bestätigungslink ist unvollständig.",es:"El enlace de verificación está incompleto.",tr:"Doğrulama bağlantısı eksik."}};function pn(){const{isAuthenticated:r,loading:a,isPasswordRecovery:l}=R(),{language:t}=B(),[o,n]=i.useState(!1),[s,d]=i.useState(!1),[h,m]=i.useState(null),[p,y]=i.useState(null);return i.useEffect(()=>{const c=new URLSearchParams(window.location.search);c.get("verified")==="true"&&(d(!0),window.history.replaceState({},"",window.location.pathname),setTimeout(()=>d(!1),8e3));const u=c.get("verify_error");u&&(m(u),window.history.replaceState({},"",window.location.pathname),setTimeout(()=>m(null),1e4));const w=c.get("reset_token");w&&(y(w),window.history.replaceState({},"",window.location.pathname))},[]),a?e.jsx("div",{className:"min-h-screen flex items-center justify-center bg-[var(--color-background)]",children:e.jsx("div",{className:"w-8 h-8 border-4 border-[#D4522A] border-t-transparent rounded-full animate-spin"})}):r&&o?e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"min-h-screen flex items-center justify-center bg-[var(--color-background)]",children:e.jsx("div",{className:"w-8 h-8 border-4 border-[#D4522A] border-t-transparent rounded-full animate-spin"})}),children:e.jsx(un,{onBackToHome:()=>n(!1)})}):e.jsxs("div",{className:"min-h-screen bg-[var(--color-background)] text-[var(--color-text)] transition-colors duration-300 overflow-x-hidden w-full max-w-full",children:[l&&e.jsx(ce,{}),p&&e.jsx(ce,{resetToken:p,onClose:()=>y(null)}),s&&e.jsxs("div",{className:"fixed top-4 left-1/2 -translate-x-1/2 z-[9999] bg-green-600 text-white px-6 py-3 rounded-xl shadow-2xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4 max-w-[90vw]",children:[e.jsx("svg",{className:"w-5 h-5 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})}),e.jsx("span",{className:"font-medium text-sm",children:de[t]||de.ru}),e.jsx("button",{onClick:()=>d(!1),className:"ml-2 text-white/80 hover:text-white",children:"×"})]}),h&&e.jsxs("div",{className:"fixed top-4 left-1/2 -translate-x-1/2 z-[9999] bg-red-600 text-white px-6 py-3 rounded-xl shadow-2xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4 max-w-[90vw]",children:[e.jsx("svg",{className:"w-5 h-5 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})}),e.jsx("span",{className:"font-medium text-sm",children:(L[h]||L.invalid)[t]||(L[h]||L.invalid).ru}),e.jsx("button",{onClick:()=>m(null),className:"ml-2 text-white/80 hover:text-white",children:"×"})]}),e.jsx($e,{onGoToDashboard:()=>n(!0)}),e.jsx(Ze,{onGoToDashboard:()=>n(!0)},t),e.jsxs(i.Suspense,{fallback:null,children:[e.jsx(Xe,{}),e.jsx(en,{}),e.jsx(nn,{}),e.jsx(tn,{}),e.jsx(Je,{}),e.jsx(an,{}),e.jsx(rn,{}),e.jsx(sn,{}),e.jsx(on,{}),e.jsx(ln,{}),e.jsx(cn,{}),e.jsx(dn,{})]})]})}function mn(){return e.jsx(Fe,{children:e.jsx(Ge,{children:e.jsx(Oe,{defaultTheme:"light",storageKey:"chefnet-theme",children:e.jsx(pn,{})})})})}const ye=document.getElementById("root");if(!ye)throw new Error("Failed to find the root element");Ce.createRoot(ye).render(e.jsx(i.StrictMode,{children:e.jsx(mn,{})}));export{$ as L,R as a,Ke as g,te as t,B as u};
