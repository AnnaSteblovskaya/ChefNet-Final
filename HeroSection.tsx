...
export default function HeroSection({ onGoToDashboard }: HeroSectionProps) {
  ...
  return (
    <section id="home" className="relative bg-background px-4 pb-8 pt-6 sm:px-6 md:px-8" aria-label="Hero">
      {/* Desktop Version */}
      <div 
      ...
      >
        ...
        <div className="relative z-10 px-8 py-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              aria-label="Home"
            >
              <ChefHat className="w-5 h-5 text-[#FF6B35] drop-shadow-[0_2px_8px_rgba(255,107,53,0.5)]" aria-hidden="true" />
        ...
        <img
          src={heroBg}
          alt="ChefNet FoodTech platform showcase"
          ...
          <div className="px-4 py-3">
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                aria-label="Home"
              >
                <ChefHat className="w-4 h-4 text-[#FF6B35] drop-shadow-[0_2px_8px_rgba(255,107,53,0.5)]" aria-hidden="true" />
                <div className="whitespace-nowrap">
