...
async function ensureDbSchema() {
  ...
  // ── Seed default landing-page content into site_content (won't overwrite admin edits) ──
  try {
    const defaultContent: Array<{
      ...
      { key: 'hero_subtitle', label: 'Подзаголовок', section: 'hero', type: 'text',
        ...
        es: 'ChefNet es una tecnología impulsada por IA,',
        tr: "ChefNet, yapay zeka destekli bir teknoloji," },
      { key: 'hero_description', label: 'Описание', section: 'hero', type: 'text',
        ...
        de: 'die Ihren Rhythmus kennenlernt, Ihren Geschmack erinnert und Ihnen täglich Zeit und Geld spart.',
        es: 'que aprende tu ritmo, recuerda tu sabor y te ahorra tiempo y dinero cada día.',
        tr: 'ritminizi öğrenen, zevkinizi hatırlayan ve her gün size zaman ve para kazandıran.' },
      { key: 'hero_benefit1', label: 'Преимущество 1', section: 'hero', type: 'text',
        ...
        tr: 'Restoranlar yeni misafirler kazanır.' },
      { key: 'hero_benefit2', label: 'Преимущество 2', section: 'hero', type: 'text',
        ...
        es: 'Los huéspedes reciben recomendaciones precisas y personalizadas.',
        tr: 'Misafirler hassas, kişiselleştirilmiş öneriler alır.' },
      { key: 'hero_benefit3', label: 'Преимущество 3', section: 'hero', type: 'text',
        ...
        tr: 'Ortaklar şeffaf büyüme ve dinamik piyasadan yararlanır.' },
      { key: 'hero_cta', label: 'Призыв к действию', section: 'hero', type: 'text',
        ...
        es: 'Ahora es tu oportunidad de unirte a este movimiento.',
        tr: 'Şimdi bu harekete katılma fırsatınız.' },
      // ── Advantages ───────────────────────────────────────────────────────────
      ...
      { key: 'inv_seed_back_title', label: 'Seed — задняя сторона, заголовок', section: 'investments', type: 'text',
        en: 'Development of the app MVP', ru: 'Разработка MVP приложения',
        de: 'Entwicklung der App MVP', es: 'Desarrollo del MVP de la aplicación',
        tr: 'Uygulama MVP geliştirme' },
      { key: 'inv_seed_back_desc', label: 'Seed — задняя сторона, описание', section: 'investments', type: 'text',
        ...
        es: '• Adquisición de usuarios\n• Negociaciones con restaurantes\n• Contratación de gerentes de país\n• KPI: 10K usuarios',
        tr: '• Kullanıcı kazanımı\n• Restoranlarla müzakereler\n• Ülke yöneticileri işe alımı\n• KPI: 10K kullanıcı' },
      { key: 'inv_private_back_title', label: 'Private — задняя сторона, заголовок', section: 'investments', type: 'text',
        en: 'MVP Testing', ru: 'Тестирование MVP', de: 'Test des MVP',
        es: 'Pruebas del MVP', tr: 'MVP Testi' },
      { key: 'inv_private_back_desc', label: 'Private — задняя сторона, описание', section: 'investments', type: 'text',
        ...
        ru: '• Тестирование MVP в ключевых городах США и Европы\n• Партнерство с ресторанными ассоциациями\n• Улучшение AI рекомендаций\n• KPI: 100K пользователей, 500 ресторанов',
        de: '• MVP-Tests in Schlüsselstädten der USA und Europas\n• Partnerschaften mit Restaurantverbänden\n• Verbesserung der KI-Empfehlungen\n• KPI: 100K Nutzer, 500 Restaurants',
        es: '• Pruebas del MVP en ciudades clave de EE.UU. y Europa\n• Asociaciones con asociaciones de restaurantes\n• Mejora de recomendaciones de IA\n• KPI: 100K usuarios, 500 restaurantes',
        tr: '• MVP testleri ABD ve Avrupa şehirlerinde\n• Restoran dernekleriyle ortaklıklar\n• AI önerilerinin geliştirilmesi\n• KPI: 100K kullanıcı, 500 restoran' },
      { key: 'inv_marketing_back_title', label: 'Marketing — задняя сторона, заголовок', section: 'investments', type: 'text',
        en: 'Integration with ride-sharing services', ru: 'Интеграция с сервисами такси',
        de: 'Integration mit Ride-Sharing-Diensten', es: 'Integración con servicios de transporte',
        tr: 'Araç paylaşım hizmetleriyle entegrasyon' },
      { key: 'inv_marketing_back_desc', label: 'Marketing — задняя сторона, описание', section: 'investments', type: 'text',
        en: '• Integration with Uber, Lyft, Bolt\n• Launch of the full ChefNet app\n• Fintech module (payments, cashback)\n• KPI: 1M users, 5K restaurants, $1M profit',
        ru: '• Интеграция с Uber, Lyft, Bolt\n• Запуск полного приложения ChefNet\n• Финтех-модуль (оплата, кэшбэк)\n• KPI: 1M пользователей, 5K ресторанов, $1M прибыли',
        de: '• Integration mit Uber, Lyft, Bolt\n• Start der vollständigen ChefNet-App\n• Fintech-Modul (Zahlungen, Cashback)\n• KPI: 1M Nutzer, 5K Restaurants, $1M Gewinn',
        es: '• Integración con Uber, Lyft, Bolt\n• Lanzamiento de la app completa de ChefNet\n• Módulo fintech (pagos, cashback)\n• KPI: 1M usuarios, 5K restaurantes, $1M de ganancia',
        tr: '• Uber, Lyft, Bolt entegrasyonu\n• Tam ChefNet uygulaması lansmanı\n• Fintech modülü (ödemeler, geri ödeme)\n• KPI: 1M kullanıcı, 5K restoran, $1M kâr' },
      { key: 'inv_public_back_title', label: 'Public/IPO — задняя сторона, заголовок', section: 'investments', type: 'text',
        ...
        de: 'Expansion nach Asien, Lateinamerika und dem Nahen Osten',
        es: 'Expansión a Asia, América Latina y Oriente Medio',
        tr: 'Asya, Latin Amerika ve Orta Doğu\'ya genişleme' },
      { key: 'inv_public_back_desc', label: 'Public/IPO — задняя сторона, описание', section: 'investments', type: 'text',
        en: '• Scaling to a global SuperApp\n• DAO community and NFT programs\n• IPO preparation at $3–5B valuation\n• KPI: 30M users, 50K restaurants, $100M+ profit',
        ru: '• Масштабирование до глобального SuperApp\n• DAO-комьюнити и NFT-программы\n• Подготовка к IPO с капитализацией $3–5B\n• KPI: 30M пользователей, 50K ресторанов, $100M+ прибыли',
        de: '• Skalierung zur globalen SuperApp\n• DAO-Community und NFT-Programme\n• IPO-Vorbereitung bei $3–5B Bewertung\n• KPI: 30M Nutzer, 50K Restaurants, $100M+ Gewinn',
        es: '• Escalado a SuperApp global\n• Comunidad DAO y programas NFT\n• Preparación para IPO con valoración de $3–5B\n• KPI: 30M usuarios, 50K restaurantes, $100M+ de ganancia',
        tr: '• Küresel SuperApp\'a ölçeklendirme\n• DAO topluluğu ve NFT programları\n• $3–5B değerlemeyle IPO hazırlığı\n• KPI: 30M kullanıcı, 50K restoran, $100M+ kâr' },
      // ── Opportunities ────────────────────────────────────────────────────────
      ...
      { key: 'opp_item1_desc', label: 'Пункт 1 — описание', section: 'opportunities', type: 'text',
        ...
        ru: 'ChefNet Invest — это ваш шанс присоединиться к рождению глобального тренда и технологического гиганта.',
        de: 'ChefNet Invest ist Ihre Chance, an der Entstehung eines globalen Trends teilzuhaben.',
        es: 'ChefNet Invest es tu oportunidad de unirte al nacimiento de una tendencia global.',
        tr: "ChefNet Invest, küresel bir trendin doğuşuna katılma fırsatınızdır." },
      ...
      { key: 'opp_item2_desc', label: 'Пункт 2 — описание', section: 'opportunities', type: 'text',
        ...
        ru: 'Booking, Uber, Airbnb, Amazon когда-то тоже не существовали. Следующее имя в этом списке — ChefNet!',
        de: 'Booking, Uber, Airbnb, Amazon existierten früher auch nicht. Das nächste in dieser Liste — ChefNet!',
        es: 'Booking, Uber, Airbnb, Amazon tampoco existían antes. El siguiente en la lista — ChefNet!',
        tr: 'Booking, Uber, Airbnb, Amazon da bir zamanlar yoktu. Bu listedeki bir sonraki isim — ChefNet!' },
      ...
      { key: 'opp_item3_desc', label: 'Пункт 3 — описание', section: 'opportunities', type: 'text',
        ...
        es: 'ChefNet es una revolución en el mundo de las apps de comida — una idea cuyo tiempo ha llegado.',
        tr: "ChefNet, yemek uygulamaları dünyasında bir devrim — zamanı gelmiş bir fikir." },
      // ── Partnership ──────────────────────────────────────────────────────────
